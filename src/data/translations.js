export const translations = {
    pt: {
        ...
        skills: {
            ...
            list: [
                { id: 1,  name: 'Delphi 11',      icon_class: 'fas fa-desktop',             category: 'Back-end',     color: '#E63946', desc: 'VCL / UniGui, Sistemas ERP & PDV' },
                { id: 2,  name: 'UniGui Web',     icon_class: 'fas fa-globe',               category: 'Back-end',     color: '#457B9D', desc: 'Aplicações Web em tempo real com Delphi' },
                ...
                { id: 7,  name: 'MySQL',          icon_class: 'fas fa-server',              category: 'Database',     color: '#00758F', desc: 'Modelagem relacional & Otimização' },
                ...
                { id: 10, name: 'Java / Swing',   icon_class: 'fab fa-java',                category: 'Back-end',     color: '#ED8B00', desc: 'Estruturas de dados & POO' },
                { id: 11, name: 'Python / Flask', icon_class: 'fab fa-python',              category: 'Back-end',     color: '#3776AB', desc: 'Automações, Scripts & Micro-APIs' },
                { id: 12, name: 'Tailwind CSS',   icon_class: 'fab fa-css3-alt',            category: 'Front-end',    color: '#38BDF8', desc: 'Design systems, Layouts fluidos & Responsividade' },
    ...
    en: {
        ...
        skills: {
            ...
            list: [
                { id: 1,  name: 'Delphi 11',      icon_class: 'fas fa-desktop',             category: 'Back-end',     color: '#E63946', desc: 'VCL / UniGui, ERP & POS Systems' },
                { id: 2,  name: 'UniGui Web',     icon_class: 'fas fa-globe',               category: 'Back-end',     color: '#457B9D', desc: 'Real-time Web Applications with Delphi' },
                ...
                { id: 7,  name: 'MySQL',          icon_class: 'fas fa-server',              category: 'Database',     color: '#00758F', desc: 'Relational Modeling & Optimization' },
                ...
                { id: 10, name: 'Java / Swing',   icon_class: 'fab fa-java',                category: 'Back-end',     color: '#ED8B00', desc: 'Data Structures & OOP' },
                { id: 11, name: 'Python / Flask', icon_class: 'fab fa-python',              category: 'Back-end',     color: '#3776AB', desc: 'Automations, Scripts & Micro-APIs' },
                { id: 12, name: 'Tailwind CSS',   icon_class: 'fab fa-css3-alt',            category: 'Front-end',    color: '#38BDF8', desc: 'Design Systems, Fluid Layouts & Responsive' },
    ...
    es: {
        ...
        skills: {
            ...
            list: [
                { id: 1,  name: 'Delphi 11',      icon_class: 'fas fa-desktop',             category: 'Back-end',     color: '#E63946', desc: 'VCL / UniGui, Sistemas ERP & POS' },
                { id: 2,  name: 'UniGui Web',     icon_class: 'fas fa-globe',               category: 'Back-end',     color: '#457B9D', desc: 'Aplicaciones Web en tiempo real con Delphi' },
                ...
                { id: 7,  name: 'MySQL',          icon_class: 'fas fa-server',              category: 'Database',     color: '#00758F', desc: 'Modelado relacional & Optimización' },
                ...
                { id: 10, name: 'Java / Swing',   icon_class: 'fab fa-java',                category: 'Back-end',     color: '#ED8B00', desc: 'Estructuras de datos & POO' },
                { id: 11, name: 'Python / Flask', icon_class: 'fab fa-python',              category: 'Back-end',     color: '#3776AB', desc: 'Automatizaciones, Scripts & Micro-APIs' },
                { id: 12, name: 'Tailwind CSS',   icon_class: 'fab fa-css3-alt',            category: 'Front-end',    color: '#38BDF8', desc: 'Design systems, Layouts fluidos & Responsividad' },
