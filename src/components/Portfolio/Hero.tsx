...
export const Hero: React.FC = () => {
    ...
    return (
        ...
        >
            {/* Background blobs — otimizados para aceleração por hardware GPU */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
                    ...
                    >
                        ...
                        <p className="text-gray-400 max-w-lg mx-auto lg:mx-0 text-base sm:text-lg leading-relaxed min-h-[72px]">
                            {t('hero.description')}{' '}
